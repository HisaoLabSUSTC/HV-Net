/*
	Ihk_PolarC.cpp		Mex C++ file for I_h^k hypervolume indicator approximation by polar coordinate
	
	Usage: Ihk_PolarC(points, reference point, param_k, samples)
